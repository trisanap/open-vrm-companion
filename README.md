...
A fully local, expressive AI companion with a 3D VRM character, voice, emotions, animations, and an agentic research mode. Built on Python Flask + Three.js, powered by the Groq API (or swap in any OpenAI-compatible backend).
